          ...
          <div className="relative flex h-16 items-center justify-between">
            ...
            <div className="hidden sm:ml-6 sm:block">
              <div className="flex space-x-4">
                <button
                  type="button"
                  className="relative rounded-full bg-gray-800 p-1 hover:bg-[#c0ff00] text-[white] hover:text-black hover:text-black hover:border-none focus:outline-none bg-transparent border border-white px-3"
                  onClick={() => setModalOpen(true)}
                >
                  <span className=" font-medium  uppercase">Get a Quote</span>
                </button>
              </div>
            </div>
            <div className="absolute inset-y-0 right-0 flex items-center sm:hidden">
              <button
                ...
                className="inline-flex items-center justify-center p-2  hover:bg-gray-700 hover:text-white focus:outline-none"
              >
