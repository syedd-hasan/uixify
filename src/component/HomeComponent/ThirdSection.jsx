    ...
    <div id="projects" className="bg-[#7366fc] py-14">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 justify-center mt-6 md:mt-14">
          <button
            type="button"
            className="relative rounded-full bg-gray-800 p-1 text-gray-400 hover:bg-[#c0ff00] hover:text-black hover:border-none focus:outline-none bg-transparent border border-white px-6"
            data-aos="fade-up"
          >
